...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '2f9d4b54-b4b1-4ae0-98a9-91b142e0f5ce' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('f4ecf41a-e573-42da-87d6-18432b3d8fd6');
      cy.get(`[data-cy="name"]`).should('have.value', 'f4ecf41a-e573-42da-87d6-18432b3d8fd6');
